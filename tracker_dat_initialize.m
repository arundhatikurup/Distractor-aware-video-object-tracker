...
%     disp (size(region(1)) )
  ...
  % Scale data
  state.scale_factor =  min(1, round(10*cfg.img_scale_target_diagonal/sqrt(sum(target_sz.^2)))/10);%1;
  ...
  state.prob_lut_distractor = state.prob_lut; % Copy initial discriminative model                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            prob_lut; % Copy initial discriminative model
